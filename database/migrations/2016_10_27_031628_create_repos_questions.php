...
class CreateReposQuestions extends Migration
{
    ...
    public function up()
    {
        Schema::create('repos_questions', function (Blueprint $table) {
            ...
            $table->timestamp('creation_date')->default('0000-00-00 00:00:00');
            $table->timestamp('last_edit_date')->default('0000-00-00 00:00:00');
            $table->timestamp('last_activity_date')->default('0000-00-00 00:00:00');
        });
    }
