            ...
            <div class="col-md-7 col-sm-8">
                ...
                <div class="params">
                    <div style="margin-bottom: 10px;">
                        <a aria-label="Star {{ $repos->owner }}/{{ $repos->repo }} on GitHub" data-count-aria-label="# stargazers on GitHub" data-count-api="/repos/{{ $repos->owner }}/{{ $repos->repo }}#stargazers_count" data-count-href="/{{ $repos->owner }}/{{ $repos->repo }}/stargazers" data-icon="octicon-star" href="{{ link_url("https://github.com/$repos->owner/$repos->repo") }}" class="github-button" target="_blank" rel="nofollow">Star</a>
                        <a aria-label="Fork {{ $repos->owner }}/{{ $repos->repo }} on GitHub" data-count-aria-label="# forks on GitHub" data-count-api="/repos/{{ $repos->owner }}/{{ $repos->repo }}#forks_count" data-count-href="/{{ $repos->owner }}/{{ $repos->repo }}/network" data-icon="octicon-repo-forked" href="{{ link_url("https://github.com/$repos->owner/$repos->repo/fork") }}" class="github-button" target="_blank" rel="nofollow">Fork</a>
                        <a aria-label="Watch {{ $repos->owner }}/{{ $repos->repo }} on GitHub" data-count-aria-label="# watchers on GitHub" data-count-api="/repos/{{ $repos->owner }}/{{ $repos->repo }}#subscribers_count" data-count-href="/{{ $repos->owner }}/{{ $repos->repo }}/watchers" data-icon="octicon-eye" href="{{ link_url("https://github.com/$repos->owner/$repos->repo") }}" class="github-button" target="_blank" rel="nofollow">Watch</a>
                        <a aria-label="Issue {{ $repos->owner }}/{{ $repos->repo }} on GitHub" data-count-aria-label="# issues on GitHub" data-count-api="/repos/{{ $repos->owner }}/{{ $repos->repo }}#open_issues_count" data-icon="octicon-issue-opened" href="{{ link_url("https://github.com/$repos->owner/$repos->repo/issues") }}" class="github-button" target="_blank" rel="nofollow">Issue</a>
                        <a aria-label="Download {{ $repos->owner }}/{{ $repos->repo }} on GitHub" data-icon="octicon-cloud-download" href="https://github.com/{{ $repos->owner }}/{{ $repos->repo }}/archive/master.zip" class="github-button" rel="nofollow">Download</a>
                    </div>
