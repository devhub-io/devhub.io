            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="single-sidebar">
                        <h2 class="sidebar-title">子级分类</h2>
                        <ul>
                    ...
                    <div class="product-content-right">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail"><a href="{{ url('repos', [$item->slug]) }}"><img alt="100%x200" data-src="holder.js/100%x200"
                                    ...
                                    <div class="caption">
                                        <a href="{{ url('repos', [$item->slug]) }}"><h3>{{ $item->title }}</h3></a>
