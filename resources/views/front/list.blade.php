                    ...
                    <div class="product-content-right">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail"><a href="{{ l_url('repos', [$item->slug]) }}">
                                    <img style="height: 200px; width: 100%; display: block;" src="{{ $item->image > 0 ? image_url($item->image, ['h' => 200]) : 'holder.js/200x200' }}" data-holder-rendered="true"></a>
                                    <div class="caption">
