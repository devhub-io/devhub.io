                    ...
                    <div class="product-carousel">
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="{{ $item->cover ? $item->cover . '&s=210' : cdn_asset('img/210x269.png') }}" alt="{{ $item->title }}" title="{{ $item->title }}" class="lazyload" width="210">
            ...
            <div class="col-md-4">
                <div class="single-product-widget">
                    ...
                    <div class="single-wid-product">
                        <a href="{{ l_url('repos', [$item->slug]) }}"><img src="{{ $item->cover ? $item->cover . '&s=100' :cdn_asset('img/100x90.png') }}" alt="{{ $item->title }}" title="{{ $item->title }}" class="product-thumb lazyload" width="100" height="100"></a>
                        <h2><a href="{{ l_url('repos', [$item->slug]) }}">{{ $item->title }}</a></h2>
                        <div class="product-wid-rating">
